    ...
    if request.method == 'GET':
        ...
        try:
            ...
            if(conn != None):
                ...
                conn.close()
            if(rows == 1):
                return Response("Car has been uploaded!", mimetype = "text/html", status = 201)
            else:
                return Response("Something went wrong... please try again", mimetype = "text/html", status = 500)
        ...
        try:
            ...
            if(conn != None):
                ...
                conn.close()
            if(rows == 1):
                return Response("Car has been updated!", mimetype = "text/html", status = 204)
            else:
                return Response("Something went wrong... please try again", mimetype = "text/html", status = 500)
        ...
        try:
            ...
            if(conn != None):
                ...
                conn.close()
            if(rows == 1):
                return Response("Car has been deleted!", mimetype = "text/html", status = 200)
            else:
                return Response("Something went wrong... please try again", mimetype = "text/html", status = 500)